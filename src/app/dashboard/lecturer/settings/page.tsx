                ...
                <div className="pt-4 border-t dark:border-gray-700">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        className={`px-3 py-1 text-xs rounded-md ${
                          userData.connectedAccounts.google
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        className={`px-3 py-1 text-xs rounded-md ${
                          userData.connectedAccounts.github
                            ? theme === 'dark' ? 'bg-gray-700 text-gray-300' : 'bg-gray-200 text-gray-700'
                            : theme === 'dark' ? 'bg-blue-600 text-white' : 'bg-blue-500 text-white'
                        }`}
                      >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        className={`px-3 py-1 text-xs rounded-md ${
                          userData.connectedAccounts.linkedin
                            ? theme === 'dark' ? 'bg-gray-700 text-gray-300' : 'bg-gray-200 text-gray-700'
                            : theme === 'dark' ? 'bg-blue-600 text-white' : 'bg-blue-500 text-white'
                        }`}
                      >
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none ${
                        userData.emailNotifications.courseUpdates
                          ? 'bg-blue-600'
                    ...
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                          userData.emailNotifications.courseUpdates ? 'translate-x-6' : 'translate-x-1'
                        }`}
                      />
                    </button>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none ${
                        userData.emailNotifications.studentMessages
                          ? 'bg-blue-600'
                          : theme === 'dark' ? 'bg-gray-600' : 'bg-gray-300'
                      }`}
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                          userData.emailNotifications.studentMessages ? 'translate-x-6' : 'translate-x-1'
                        }`}
                      />
                    </button>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none ${
                        userData.emailNotifications.studentSubmissions
                          ? 'bg-blue-600'
                          : theme === 'dark' ? 'bg-gray-600' : 'bg-gray-300'
                      }`}
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                          userData.emailNotifications.studentSubmissions ? 'translate-x-6' : 'translate-x-1'
                        }`}
                      />
                    </button>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none ${
                        userData.emailNotifications.platformAnnouncements
                          ? 'bg-blue-600'
                          : theme === 'dark' ? 'bg-gray-600' : 'bg-gray-300'
                      }`}
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                          userData.emailNotifications.platformAnnouncements ? 'translate-x-6' : 'translate-x-1'
                        }`}
                      />
                    </button>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none ${
                        userData.emailNotifications.marketingEmails
                          ? 'bg-blue-600'
                          : theme === 'dark' ? 'bg-gray-600' : 'bg-gray-300'
                      }`}
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                          userData.emailNotifications.marketingEmails ? 'translate-x-6' : 'translate-x-1'
                        }`}
                      />
                    </button>
                  </div>
